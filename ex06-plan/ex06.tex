...
\begin{document}
    ...
    \begin{itemize}
    	\item[a)]    	
    	The cumulative reward for the Dyna-Q+ agent is higher since he will get a special bonus reward for testing all accessible state transaction. Especially those who have not been considered in a long time: The longer unvisited, the more reward for visiting. 
